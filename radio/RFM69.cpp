...
{
	//New config information from https://lowpowerlab.com/forum/index.php/topic,114.0.html
	const byte CONFIG[][2] =
  {
	...
	/* 0x58 */ { REG_TESTLNA, RF_TESTLNA_HIGH_SENSITIVITY }, 	// Increases the sensitivity by 2-3db by enabling the low noise pre-amp
